...
<div id="log">
    <form method="POST">
        ...
        <input type="submit" name="find" value="Find" style="background-color: #ebd231;">
    </form>
    <form method="POST">
        <input type="submit" name="sort" value="A-Z" style="background-color: #ebd231;">
        <input type="submit" name="sortDesc" value="Z-A" style="background-color: #ebd231;">
    </form>
    <?php
    ...
    ?>
        ...
        <h3 style="margin:10px 30px 30px 0px; color:#ebd231; font-weight: 600;"> Details of Patients directly Admitted By Hospitals</h3>
            ...
            <table id="tbl" border="1">
                ...
                <?php
                $q = "SELECT * FROM patients p,bedcategory bc,bedrequest bb, `hospital` h WHERE bb.`pid`=p.`pat_id`  AND bb.`status`<>'Discharged' AND p.`name` LIKE '%$user%' AND bb.`bcid`= bc.`bcid` AND p.`email`NOT IN ( SELECT `user_name` FROM `login`) AND bb.`hid`=h.`hospital_id`";
    ...
    ?>
        ...
        <h3 style="margin:10px 30px 30px 0px; color:#ebd231; font-weight: 600;"> Details of Patients directly Admitted By Hospitals</h3>
            ...
            <table id="tbl" border="1">
                ...
                <?php
                $q = "SELECT * FROM patients p,bedcategory bc,bedrequest bb, `hospital` h WHERE bb.`pid`=p.`pat_id`  AND bb.`status`<>'Discharged' AND bb.`bcid`= bc.`bcid` AND p.`email`NOT IN ( SELECT `user_name` FROM `login`) AND bb.`hid`=h.`hospital_id` ORDER BY p.name";
    ...
    ?>
        ...
        <h3 style="margin:10px 30px 30px 0px; color:#ebd231; font-weight: 600;"> Details of Patients directly Admitted By Hospitals</h3>
            ...
            <table id="tbl" border="1">
                ...
                <?php
                $q = "SELECT * FROM patients p,bedcategory bc,bedrequest bb, `hospital` h WHERE bb.`pid`=p.`pat_id` AND bb.`status`<>'Discharged' AND bb.`bcid`= bc.`bcid` AND p.`email`NOT IN ( SELECT `user_name` FROM `login`) AND bb.`hid`=h.`hospital_id` ORDER BY p.name DESC";
